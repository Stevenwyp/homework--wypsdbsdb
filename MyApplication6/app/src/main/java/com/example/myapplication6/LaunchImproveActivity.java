...
import com.example.myapplication6.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.car1,R.drawable.car2, R.drawable.car3, R.drawable.car4};
